...
static void writeDebugLog(NSString *message) {
    NSString *logPath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"scimonetify_debug.log"];
...
__attribute__((constructor)) static void init() {
    @try {
        NSLog(@"[Scimonetify] Initializing tweak...");

        // Initialize Orion - do not remove this line.
        orion_init();

        NSLog(@"[Scimonetify] Tweak initialized successfully");
